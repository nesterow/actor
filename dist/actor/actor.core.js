...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='actor']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"actor","hydrated",[["actor-layout","actor-layout",1,[["alerts",1,0,1,2],["footer",1,0,1,2],["header",1,0,1,2],["overlay",1,0,1,2],["root",64],["sidebar",1,0,1,2]],1]]);